...
# Bridgehead mode
docker compose -f bbmri-sample-locator/compose.bridgehead.yaml up --pull always
# Bridgehead mode (Test)
docker compose -f bbmri-sample-locator/compose.bridgehead.yaml -f bbmri-sample-locator/compose.bridgehead.test.yaml up --pull always
```
